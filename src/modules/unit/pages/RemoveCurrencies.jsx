...
import { getClasses } from "../../../redux/classes.js";
import { useSidebarContext } from "../../../pages/global/sidebar/sidebarContext.js";
import { getCurrencies } from "../../../redux/currencies.js";

const RemoveCurrencies = ({ id, icon, sx, pageSize }) => {
...
export default RemoveCurrencies;
